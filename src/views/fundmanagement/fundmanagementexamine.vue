    ...
    <div class="app-container">
        <div style="margin:20px 0;display: flex;justify-content: space-between;">
            <div class="filter-container">
                ...
                <el-select v-if="Userinfo.role_id!=6" v-model="Financetext" clearable placeholder="财务审核"
                           style="width: 150px;margin-left: 20px;"
                           @change="changeFinance">
                    <el-option v-for="item in Finance" :key="item.state" :label="item.text"
                               :value="item.state"/>
                </el-select>
                <el-select v-if="Userinfo.role_id!=3" v-model="Operatetext" clearable placeholder="运营审核"
                           style="width: 150px;margin-left: 20px;"
        ...
        <el-table
            ...
            <el-table-column label="财务审核状态" width="150px" align="center" v-if="Userinfo.role_id==3">
                <template slot-scope="scope">
            ...
            <el-table-column label="运营审核状态" width="150px" align="center" v-if="Userinfo.role_id==6">
                <template slot-scope="scope">
                    <i v-if="scope.row.operate_examine_state!=1"  class="fa fa-circle text-danger ml5" style="color: red"/>
                    <i v-else class="fa fa-circle text-success ml5" style="color: #15db81"/>
                </template>
            </el-table-column>
            <el-table-column label="操作" width="150px" align="center" v-if="Userinfo.role_id==3||Userinfo.role_id==6">
                <template slot-scope="scope">
                    <el-button type="primary" size="mini" @click="dialogedits(scope.row)">审核</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog
                ...
                title="运营部审核"
                width="40%">
            <el-form ref="addForm" :model="CodeInfo" size="small" label-width="100px">
                <el-form-item prop="ms_login_password" label="公司名称">
                    <el-input
                            v-model="CodeInfo.companyname"
                            maxlength="20"
                            clearable
                            disabled
                            placeholder=""
                ...
                <el-form-item prop="ms_email" label="流水号">
                    <el-input
                            v-model="CodeInfo.remittance_flow"
                            maxlength="100"
                            style="width: 300px;"
                            placeholder=""
                            disabled
                ...
                <el-form-item prop="ms_login_password" label="汇入银行">
                    <el-input
                            v-model="CodeInfo.paying_bank"
                            maxlength="20"
                            clearable
                            placeholder=""
                            disabled
                ...
                <el-form-item prop="ms_login_password" label="汇款银行">
                    <el-input
                            v-model="CodeInfo.remittance_bank"
                            maxlength="20"
                            clearable
                            placeholder=""
                            disabled
                ...
                <el-form-item prop="ms_login_password" label="申请金额">
                    <el-input
                            v-model="CodeInfo.reserve_gold_balance"
                            maxlength="20"
                            clearable
                            placeholder=""
                            disabled
                ...
                <el-form-item label="是否审核" prop="oil_change_date">
                    <el-select v-model="Selectstate" style="width: 300px;" clearable placeholder="请选择" @change="changeyunying" >
                        <el-option
        ...
        <el-dialog
            ...
            <el-form ref="addForm" :model="CodeInfo" size="small" label-width="100px">
                ...
                <el-form-item label="是否审核" prop="oil_change_date">
                    <el-select v-model="Selectstate" style="width: 300px;" clearable placeholder="请选择" @change="changecaiwu" >
                        <el-option
                                v-for="item in Operates"
                                :key="item.state"
                                :label="item.text"
        ...
        <el-button type="primary" @click="EditCodes">确 定</el-button>
      </span>
        </el-dialog>
        ...
        methods: {
            ...
            EditCode(){
                var json={
                    ...
                    operate_examine_state:this.yunyingbu,
                    reserve_gold_id:this.reserve_gold,
                    company_id:this.Companyid,
                    reserve_user:this.Userinfo.user_name
                }
                console.log(json)
                ...
                SubMitEGoldInfo(datas).then(response => {
                    ...
                    if(response.data.result==1&&response.data.message=='当前申请财务未审核'){
            ...
            changeyunying(val){
                if(val==''||val==null){
                    this.yunyingbu=this.yunyinflag
                }
                else{
                    if(val=='ok'){
                        this.yunyingbu=1
            ...
            EditCodes(){
                var json={
                    role_id:this.Userinfo.role_id,
                    finance_examine_state:this.caiwubu,
                    reserve_gold_id:this.reserve_gold,
                    company_id:this.Companyid,
                    reserve_user:this.Userinfo.user_name
                }
            ...
            dialogedits(row){
                this.CodeInfo=row
                this.reserve_gold=row.reserve_gold_id
                if(this.Userinfo.role_id==6){
                    if(this.CodeInfo.operate_examine_state==1){
                        this.Selectstate='ok'
                        this.yunyingbu=1
                    }
                    else if(this.CodeInfo.operate_examine_state==2){
                        this.Selectstate='nook'
                        this.yunyingbu=2
                    }
                    else{
                        this.Selectstate='no'
                    ...
                    this.yunyinflag= this.yunyingbu
                    this.editDialogVisible=true
                }
                else if(this.Userinfo.role_id==3){
                    if(this.CodeInfo.finance_examine_state==1){
                        this.Selectstate='ok'
                        this.caiwubu=1
                    }
                    else if(this.CodeInfo.finance_examine_state==2){
                        this.Selectstate='nook'
                        this.caiwubu=2
                    }
                    else{
